...
class Venda(Base):
    ...
    status: Mapped[VendaStatusEnum] = mapped_column(
        SAEnum(VendaStatusEnum, name="vendastatusenum_v4"), default=VendaStatusEnum.em_andamento, nullable=False, index=True
    )
    modalidade: Mapped[ModalidadeEnum] = mapped_column(
        SAEnum(ModalidadeEnum, name="modalidadeenum_v4"), default=ModalidadeEnum.venda, nullable=False, index=True
    )
